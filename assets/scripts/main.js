...
const router = new Router(function () {
   ...
   */
  const recipe_cards = document.querySelector('.section--recipe-cards');
  recipe_cards.classList.add('shown');

  const recipe_expand = document.querySelector('.section--recipe-expand');
...
function createRecipeCards() {
  ...
  for (var i = 0; i < recipes.length; i = i + 1) {
    ...
    // Hide every recipe card with an index greater than 2
    if (i > 2) {
